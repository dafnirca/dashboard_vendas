...
with st.expander('Colunas'):
    colunas = st.multiselect('Selecione as colunas que deseja visualizar', list(dados.columns), list(dados.columns))
...
with coluna2:
    st.download_button('Download', data=converte_csv(dados_filtrados), file_name=nome_arquivo, mime= 'text/csv', on_click=mensagem_sucesso, use_container_width=True)
